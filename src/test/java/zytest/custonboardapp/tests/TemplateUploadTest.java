...
public class TemplateUploadTest  {
	 ...
	 */
	  @Test
	  public void testGetTenantConfigResponse() throws NumberFormatException, IOException
	  {
	  ...
	  @Test
	  public void testUploadXlsPositiveCase() throws IOException
	  {
		...
		/* Test Case for Upload template   /Customers/upload
		 * Check for any error code generated by the API on sending incorrect xls file
		 * In response a JSON is returned by the API and which can be validated against test error code
		 */
	  
	  @Test
	  public void testUploadXlsErrorCase() throws IOException
	  {
	 ...
	 * Here I am keeping it as an independent test, can be clubbed later with earlier upload xls test
	 */
	  @Test
	 ...
	 * Apache POI library is used for this
	 */
    @Test
